 ...
 * @title token
 */
contract AtomicBeer is ERC20, Ownable, BaseToken {
...
*/
	...
	function updateDividendTracker(address newAddress) public onlyOwner {
		...
		BABYTOKENDividendTracker newDividendTracker =
			BABYTOKENDividendTracker(payable(newAddress));
		require(
	...
	function swapAndLiquify(uint256 tokens) private {
		...
		// this is so that we can capture exactly the amount ofETH that the
		// swap creates, and not make the liquidity event includeany ETH that
